    ...
    <div className="register-container">
      <div className="content">
        ...
        <form onSubmit={handleRegister}>
          <input onChange={event => setName(event.target.value)} type="text" placeholder="Nome da ONG" />
          ...
          <div className="input-group">
            ...
            <input className="uf" placeholder="UF" onChange={event => setUf(event.target.value)} style={{ width: 80 }} />
          </div>
